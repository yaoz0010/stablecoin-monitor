...
抓取 USDS 和 GHO 的公开接口数据，按“相对前一周期下滑超过 2%”的规则判断是否告警，并通过 Lark webhook 推送到群里。项目使用纯 Python 标准库，无第三方依赖，适合直接跑在 GitHub Actions。
...
- `LARK_WEBHOOK_URL`: 必填，Lark 自定义机器人 webhook
